...
export const VIDEOS_BATALLA = ["Explosion_Elemental.mp4", "Invocaciones_Ethereas.mp4"];
...
console.log(`📚 Biblioteca DOMUS MAGI ${VERSION} cargada (${Object.keys(CARTAS).length} cartas)`);