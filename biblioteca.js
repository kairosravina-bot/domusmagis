...
export const CARTAS = {
    ...
    31: { id: 31, nombre: "SICA", elemento: "COELI", tipo: "ARMA", imgEscudo: "031.png", botones: genB(5,4,2,4), codTarget: "31" },
    32: { id: 32, nombre: "HASTA", elemento: "COELI", tipo: "ARMA", imgEscudo: "032.png", botones: genB(6,3,3,3), codTarget: "32" },
    33: { id: 33, nombre: "CLAVA", elemento: "COELI", tipo: "ARMA", imgEscudo: "033.png", botones: genB(7,1,2,5), codTarget: "33" },
    34: { id: 34, nombre: "SECURIS", elemento: "COELI", tipo: "ARMA", imgEscudo: "034.png", botones: genB(7,2,2,4), codTarget: "34" },
    35: { id: 35, nombre: "SCUTUM", elemento: "COELI", tipo: "ARMA", imgEscudo: "035.png", botones: genB(1,4,7,6), codTarget: "35" },
    36: { id: 36, nombre: "GLADIUS", elemento: "COELI", tipo: "ARMA", imgEscudo: "036.png", botones: genB(6,3,3,4), codTarget: "36" },
    37: { id: 37, nombre: "ARCUS", elemento: "COELI", tipo: "ARMA", imgEscudo: "037.png", botones: genB(6,6,1,5), codTarget: "37" },
    38: { id: 38, nombre: "MANUBALLISTA", elemento: "COELI", tipo: "ARMA", imgEscudo: "038.png", botones: genB(7,2,2,4), codTarget: "38" },
    ...
    51: { id: 51, nombre: "SICA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "051.png", botones: genB(1,5,4,3), codTarget: "51" },
    52: { id: 52, nombre: "HASTA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "052.png", botones: genB(2,6,5,5), codTarget: "52" },
    53: { id: 53, nombre: "CLAVA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "053.png", botones: genB(3,6,2,3), codTarget: "53" },
    54: { id: 54, nombre: "SECURIS", elemento: "AQUA", tipo: "ARMA", imgEscudo: "054.png", botones: genB(4,6,2,4), codTarget: "54" },
    55: { id: 55, nombre: "SCUTUM", elemento: "AQUA", tipo: "ARMA", imgEscudo: "055.png", botones: genB(5,1,5,9), codTarget: "55" },
    56: { id: 56, nombre: "GLADIUS", elemento: "AQUA", tipo: "ARMA", imgEscudo: "056.png", botones: genB(6,6,4,4), codTarget: "56" },
    57: { id: 57, nombre: "ARCUS", elemento: "AQUA", tipo: "ARMA", imgEscudo: "057.png", botones: genB(7,5,4,2), codTarget: "57" },
    58: { id: 58, nombre: "MANUBALLISTA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "058.png", botones: genB(8,7,2,3), codTarget: "58" },
    ...
    71: { id: 71, nombre: "SICA", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "071.png", botones: genB(4,3,1,7), codTarget: "71" },
    72: { id: 72, nombre: "HASTA", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "072.png", botones: genB(4,4,2,7), codTarget: "72" },
    73: { id: 73, nombre: "CLAVA", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "073.png", botones: genB(5,2,2,8), codTarget: "73" },
    74: { id: 74, nombre: "SECURIS", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "074.png", botones: genB(6,1,1,8), codTarget: "74" },
    75: { id: 75, nombre: "SCUTUM", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "075.png", botones: genB(1,5,5,9), codTarget: "75" },
    76: { id: 76, nombre: "GLADIUS", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "076.png", botones: genB(6,2,1,7), codTarget: "76" },
    77: { id: 77, nombre: "ARCUS", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "077.png", botones: genB(4,4,1,8), codTarget: "77" },
    78: { id: 78, nombre: "MANUBALLISTA", elemento: "MAGIA", tipo: "ARMA", imgEscudo: "078.png", botones: genB(2,4,2,10), codTarget: "78" },
    ...
    84: { id: 84, nombre: "LUCERNA", elemento: "COELI", tipo: "ARTEFACTO", imgEscudo: "084.png", botones: genB(1,7,2,3), codTarget: "84" },
    85: { id: 85, nombre: "APERTUM", elemento: "COELI", tipo: "ARTEFACTO", imgEscudo: "085.png", botones: genB(4,5,3,5), codTarget: "85" },
    86: { id: 86, nombre: "AEGIS", elemento: "AQUA", tipo: "ARTEFACTO", imgEscudo: "086.png", botones: genB(1,5,10,4), codTarget: "86" },
    87: { id: 87, nombre: "VEXILLUM", elemento: "MAGIA", tipo: "ARTEFACTO", imgEscudo: "087.png", botones: genB(3,9,2,3), codTarget: "87" },
    ...
    93: { id: 93, nombre: "VENENUM", elemento: "TERRA", tipo: "POCION", imgEscudo: "093.png", botones: genB(6,0,2,4), codTarget: "93" },
    94: { id: 94, nombre: "AMBROSIA", elemento: "MAGIA", tipo: "POCION", imgEscudo: "094.png", botones: genB(10,5,5,5), codTarget: "94" },
    95: { id: 95, nombre: "VELOCITAS", elemento: "AQUA", tipo: "POCION", imgEscudo: "095.png", botones: genB(12,6,2,1), codTarget: "95" },
