...
const CARTAS = {
    ...
    31: { idar: 31, id: 31, nombre: "SICA", elemento: "COELI", tipo: "ARMA", imgEscudo: "1033-CI-AR1.png", botones: genB(5,4,2,4), codTarget: "31" },
    32: { idar: 32, id: 32, nombre: "HASTA", elemento: "COELI", tipo: "ARMA", imgEscudo: "1034-CI-AR2.png", botones: genB(6,3,3,3), codTarget: "32" },
    33: { idar: 33, id: 33, nombre: "CLAVA", elemento: "COELI", tipo: "ARMA", imgEscudo: "1033-CI-AR1.png", botones: genB(7,1,2,5), codTarget: "33" },
    34: { idar: 34, id: 34, nombre: "SECURIS", elemento: "COELI", tipo: "ARMA", imgEscudo: "1034-CI-AR2.png", botones: genB(7,2,2,4), codTarget: "34" },
    35: { idar: 35, id: 35, nombre: "SCUTUM", elemento: "COELI", tipo: "ARMA", imgEscudo: "1033-CI-AR1.png", botones: genB(1,4,2,6), codTarget: "35" },
    36: { idar: 36, id: 36, nombre: "GLADIUS", elemento: "COELI", tipo: "ARMA", imgEscudo: "1034-CI-AR2.png", botones: genB(6,3,3,4), codTarget: "36" },
    37: { idar: 37, id: 37, nombre: "ARCUS", elemento: "COELI", tipo: "ARMA", imgEscudo: "1033-CI-AR1.png", botones: genB(6,6,1,5), codTarget: "37" },
    38: { idar: 38, id: 38, nombre: "MANUBALLISTA", elemento: "COELI", tipo: "ARMA", imgEscudo: "1034-CI-AR2.png", botones: genB(7,2,2,4), codTarget: "38" },
    39: { idar: 39, id: 39, nombre: "BALISTA", elemento: "COELI", tipo: "ARMA", imgEscudo: "1033-CI-AR1.png", botones: genB(9,1,2,5), codTarget: "39" },
    40: { idar: 40, id: 40, nombre: "ONIAGER", elemento: "COELI", tipo: "ARMA", imgEscudo: "1034-CI-AR2.png", botones: genB(8,1,2,7), codTarget: "40" },
    41: { idar: 41, id: 41, nombre: "SCORPIUS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1041-AG-BE.png", botones: genB(5,1,5,5), codTarget: "41" },
    42: { idar: 42, id: 42, nombre: "TRITONIS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1041-AG-BE.png", botones: genB(6,4,6,4), codTarget: "42" },
    43: { idar: 43, id: 43, nombre: "HYDRUS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1041-AG-BE.png", botones: genB(8,8,4,2), codTarget: "43" },
    44: { idar: 44, id: 44, nombre: "LEVIATHAN", elemento: "AQUA", tipo: "CASA", imgEscudo: "1041-AG-BE.png", botones: genB(9,2,7,5), codTarget: "44" },
    45: { idar: 45, id: 45, nombre: "TIAMAT", elemento: "AQUA", tipo: "CASA", imgEscudo: "1041-AG-BE.png", botones: genB(6,7,12,5), codTarget: "45" },
    46: { idar: 46, id: 46, nombre: "HASTATUS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1042-AG-HU.png", botones: genB(7,2,3,1), codTarget: "46" },
    47: { idar: 47, id: 47, nombre: "CORSARIUS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1042-AG-HU.png", botones: genB(5,3,4,2), codTarget: "47" },
    48: { idar: 48, id: 48, nombre: "ORACULUM", elemento: "AQUA", tipo: "CASA", imgEscudo: "1042-AG-HU.png", botones: genB(1,5,6,9), codTarget: "48" },
    49: { idar: 49, id: 49, nombre: "ADMIRALIS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1042-AG-HU.png", botones: genB(5,6,6,5), codTarget: "49" },
    50: { idar: 50, id: 50, nombre: "NEPTUNUS", elemento: "AQUA", tipo: "CASA", imgEscudo: "1042-AG-HU.png", botones: genB(7,8,7,6), codTarget: "50" },
    51: { idar: 51, id: 51, nombre: "SICA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1053-AG-AR1.png", botones: genB(5,4,3,2), codTarget: "51" },
    52: { idar: 52, id: 52, nombre: "HASTA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1054-AG-AR2.png", botones: genB(6,5,5,3), codTarget: "52" },
    53: { idar: 53, id: 53, nombre: "CLAVA", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1053-AG-AR1.png", botones: genB(6,2,3,1), codTarget: "53" },
    54: { idar: 54, id: 54, nombre: "SECURIS", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1054-AG-AR2.png", botones: genB(6,2,4,2), codTarget: "54" },
    55: { idar: 55, id: 55, nombre: "SCUTUM", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1053-AG-AR1.png", botones: genB(1,5,9,3), codTarget: "55" },
    56: { idar: 56, id: 56, nombre: "GLADIUS", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1054-AG-AR2.png", botones: genB(6,4,4,2), codTarget: "56" },
    57: { idar: 57, id: 57, nombre: "ARCUS", elemento: "AQUA", tipo: "ARMA", imgEscudo: "1053-TI-AG-AR1.png", botones: genB(5,4,2,3), codTarget: "57" },
...
export async function iniciarOjo(containerId, onEncontrado) {
    ...
    try {
        ...
        setInterval(() => {
            ...
            // jsQR cargado desde CDN en el HTML
